...
Computer Science related courses. I also work on various programming projects
during much of my spare time. **I'm also an incoming Freshman at the
University of Pittsburgh as a Computer Science major.**

My email can be found [here](../about.html#contact).
...
- High school/college-level math (grades 9-12, including *Algebra 2*, *Pre-Calculus/Trigonometry*, *Calculus*)
...
- Math and Science: **$30/hr**
- Computer Science:
  * Database design: **$35/hr**
  * Introductory programming: **$30/hr**
  * AP Computer Science: **$35/hr**
  * Back-end programming: **$35/hr**
...
3. Payment is accepted in 5 different ways:
    ...
    * **Cryptocurrency** (not very convenient, so I recommend other options)
...
## FAQ
* * *
*Q:* I'd like for you to tutor a certain subject, but you haven't listed it.
